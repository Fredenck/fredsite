export default function Home() {
  return (
    // p-24
    <main className="flex flex-row min-h-screen items-center justify-between p-36 h-screen">
      <div className="w-full max-w-5xl items-center justify-between font-mono basis-4/6">
        <h1>Hi, it's Fred</h1>
        <br></br>
        <p className='text-sm'>
